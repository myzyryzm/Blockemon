    ...
    class GridHelper : EditorWindow
    {
        ...
        void GenerateBaseStructure()
        {
            ...
            for (int i = 0; i < nHumanPlayer; i++)
            {
                ...
                player.GetComponent<TbsFramework.Players.Player>().PlayerNumber = players.transform.childCount;
            ...
            for (int i = 0; i < nComputerPlayer; i++)
            {
                ...
                aiPlayer.GetComponent<TbsFramework.Players.Player>().PlayerNumber = players.transform.childCount;
